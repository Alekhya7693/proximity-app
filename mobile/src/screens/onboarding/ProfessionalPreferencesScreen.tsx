...
type Props = OnboardingScreenProps<'ProfessionalPreferences'>;
...
const PROFESSIONAL_CATEGORIES = [
  {
    ...
    interests: [
      ...
      'Design', 'Engineering', 'Legal', 'Consulting', 'Real Estate',
      'Startups', 'Non-Profit',
    ],
  },
  {
    ...
    emoji: '\u{1F3AF}',
    interests: [
      'Networking', 'Mentorship', 'Co-Founding', 'Investing', 'Hiring',
      'Freelancing', 'Public Speaking', 'Writing', 'Leadership',
      'Product Management', 'Data Science', 'AI/ML',
    ],
  },
  {
    title: 'Topics',
    emoji: '\u{1F4A1}',
    interests: [
      'Entrepreneurship', 'Remote Work', 'Venture Capital', 'Blockchain',
      'SaaS', 'Growth Hacking', 'UX Design', 'DevOps', 'Cybersecurity',
      'Sustainability', 'Social Impact', 'Career Change',
    ],
  },
];
...
const ProfessionalPreferencesScreen: React.FC<Props> = ({ navigation }) => {
  ...
  const handleContinue = async () => {
    ...
    setIsLoading(true);
    try {
      await authApi.updateProfile({ professionalInterests: selected });
      updateUser({ professionalInterests: selected });
    ...
    >
      ...
      >
        ...
        <Animated.View
          ...
          style={styles.header}
        >
          <Text style={styles.headerEmoji}>{'\u{1F4BC}'}</Text>
          ...
          >
            Shape your professional network -- we'll match you with people in your industry and field
          </Text>
        </Animated.View>
        ...
        {/* Categories */}
        {PROFESSIONAL_CATEGORIES.map((category, catIdx) => (
          <Animated.View
            key={category.title}
...
export default ProfessionalPreferencesScreen;
